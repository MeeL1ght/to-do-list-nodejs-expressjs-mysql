...
// DOM - Elements
const form = dom.querySelector('#create-task-form')
...
// Create a New PlusIcon for submit button
const newPlusIcon = dom.createElement('i')

// Add attributes
newPlusIcon.setAttribute('class', 'fas fa-plus-circle')
...
form.addEventListener('submit', e => {
  ...
  if (
    ...
    submitButton.classList.add('creating-style-button')
    ...
    setTimeout(() => {
      ...
      post('./create', body)
        .then(res => {
          if (res.errorMessages.length === 0) {
            ...
            swal({
              title: 'Oops!',
              text: `The task could not be registered.\nCheck for the following errors:\n
      ...
      submitButton.classList.remove('creating-style-button')
      submitButton.classList.add('submit-button')
      submitButton.removeChild(spinnerButton)
      submitButton.textContent = 'Create '
      submitButton.appendChild(newPlusIcon)
    ...
    swal({
      title: 'Oops!',
      text: `The task could not be registered. Check for the following errors:\n
      ${errorMessages.join('\n')}`,
      icon: 'error',
      visible: true,
      button: {
